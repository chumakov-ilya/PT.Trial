...
namespace PT.Trial.Tests
{
    public class CalcServiceTests
    {
        ...
        public void GetPrevNumber_Default_ReturnsCorrectNumber(long currentIndex, long currentValue, long prevValue)
        {
        ...
        public void GetNextNumber_Default_ReturnsCorrectNumber(long currentIndex, long currentValue, long nextValue)
        {
            var current = new Number(currentIndex, currentValue);
